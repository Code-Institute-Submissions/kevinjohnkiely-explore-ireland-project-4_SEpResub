...
urlpatterns = [
    ...
    path('edit_location/<int:pk>', views.EditLocation.as_view(), name='edit_location'),
    path('publish_location/<int:location_id>', views.publish_location, name='publish_location'),
